...
import com.xingdong.seckill.order.config.MyBatisMapperScannerConfig;
...
@MapperScan(basePackages = {"com.xingdong.seckill.order.mapper","com.gitee.sunchenbin.mybatis.actable.dao.*"})
@Import(MyBatisMapperScannerConfig.class)
@SpringBootApplication(scanBasePackages =
        {"com.gitee.sunchenbin.mybatis.actable.manager.*", "com.xingdong.seckill.order.*"})
